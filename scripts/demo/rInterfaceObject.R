...
# ----------------------------------------------------------------------
# Dump Content of rInterface Object
# ----------------------------------------------------------------------
...
setMethod(f = "riExecute",
                                ...
                                verbose)
          {
            ...
            exe <- system(paste0("scp ", object@script, " ", object@user,
                                 "@", object@remote, ":~/script.R"),
            ...
            exe <- system(paste("ssh", paste0(object@user, "@", object@remote),
                                "Rscript", roptions, "script.R"),
